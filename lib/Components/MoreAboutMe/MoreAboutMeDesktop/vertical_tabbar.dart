              ...
              child: TabBarView(
                ...
                children: [
                  Container(
                    child: Column(
                      children: [
                        RatingSkill('C', '70%', 3, tabHeadingDesktoptxt),
                        SizedBox(height: 16),
                        RatingSkill('C++', '80%', 5, tabHeadingDesktoptxt),
                        SizedBox(height: 16),
                        RatingSkill('Dart', '50%', 1, tabHeadingDesktoptxt),
                        SizedBox(height: 16),
                        RatingSkill('Flutter', '50%', 1, tabHeadingDesktoptxt),
                        SizedBox(height: 16),
                        RatingSkill(
                            'UI/UX Designing', '80%', 5, tabHeadingDesktoptxt),
                      ],
                    ),
                  ),
                  Container(
